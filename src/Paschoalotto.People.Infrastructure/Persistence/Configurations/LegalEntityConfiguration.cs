...
public sealed class LegalEntityConfiguration : IEntityTypeConfiguration<LegalEntity>
{
    public void Configure(EntityTypeBuilder<LegalEntity> b)
    {
        ...
        b.Property(x => x.CorporateName).HasMaxLength(200).IsRequired();
        b.Property(x => x.TradeName).HasMaxLength(200).IsRequired();

        b.OwnsOne(x => x.Cnpj, v =>
        {
        ...
        b.Property(x => x.StateRegistration).HasMaxLength(40);
        b.Property(x => x.MunicipalRegistration).HasMaxLength(40);

        b.Property(x => x.LegalRepresentativeName).HasMaxLength(200).IsRequired();
        b.OwnsOne(x => x.LegalRepresentativeCpf, v =>
        {
            v.Property(p => p.Value)
        ...
        b.Property(x => x.LogoPath).HasMaxLength(255);
        b.Property(x => x.CreatedAtUtc).IsRequired();
        b.Property(x => x.UpdatedAtUtc).IsRequired();

        b.HasIndex(x => x.CorporateName);
        b.HasIndex(x => x.TradeName);
    }
}
